...
import { useExtractionChamber, ExtractionResult } from "../mavin/extraction/Chamber";
import { AudioEngine } from "../mavin/player/AudioEngine";
import type { PremiumStatus } from "../mavin/monetization/GracePeriod";
  ...
  const engineQuery = useQuery<EngineState>({
    ...
    queryFn: async () => {
      ...
      const initialState: EngineState = {
        ...
        lastError: null,
        analyticsSessionId: Crypto.randomUUID(), // ✅ Native UUID
      };
