...
const PlayerScreen = () => {
  ...
  const { currentTrack, isPlaying, playbackPosition, playbackDuration } = engine;
  ...
  const {  metrics, isLoading: metricsLoading } = useEngagementMetrics(currentTrack?.id || '');
  ...
  const { togglePlay, handleNext, handlePrev, handleSeek } = usePlaybackControls();

  // ============================================================================
  // ARTWORK & COLORS
  // ============================================================================
  const trackArtwork = validatedTrack?.artwork || require("@/assets/images/mavins.png");
  ...
  }, [isPremium, gracePeriodStatus, startAd, skipAdForPremium, openComments, validatedTrack]);
    ...
    return (
      <View style={[defaultStyles.container, { justifyContent: "center", alignItems: "center" }]}>
        ...
        <Text style={{ color: Colors.text, marginTop: 20, fontSize: 16 }}>
          {engine.status === 'loading' ? 'Loading track...' : 'No track playing'}
        </Text>
        <TouchableOpacity
          style={{ 
            marginTop: 20, 
  ...
  const ActionButton = ({ 
    ...
    const IconLib: any = 
      ...
      lib === "MaterialIcons" ? MaterialIcons : MaterialCommunityIcons;
        ...
        >
          <View style={styles.overlayContainer}>
            ...
            <View style={[styles.topBar, { top: top + verticalScale(12) }]}>
              ...
              >
                <Ionicons name="chevron-down" size={moderateScale(26)} color="#fff" />
              </TouchableOpacity>
              ...
              <View style={styles.topRightIcons}>
                ...
                >
                  <MaterialIcons name="equalizer" size={moderateScale(22)} color="#fff" />
                </TouchableOpacity>
                ...
                >
                  <MaterialIcons name="more-vert" size={moderateScale(22)} color="#fff" />
                </TouchableOpacity>
              </View>
            </View>
                  ...
                  <View style={styles.artworkImageContainer}>
                    ...
                    {!isPlaying && (
                      <View style={styles.pausedOverlay}>
                        <MaterialIcons name="pause" size={moderateScale(48)} color="#fff" />
                      </View>
                    )}
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  progressWrap: { flexDirection: 'row', alignItems: 'center', marginTop: verticalScale(22) },
  progressBar: { flex: 1 },
  controls: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  bottomTabsContainer: { marginTop: verticalScale(28), paddingBottom: verticalScale(20) },
  viewToggleContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-around',
